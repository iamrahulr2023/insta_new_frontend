...
//       setImages(response.data); // Response will contain images with Base64 data
//     } catch (error) {
...
//     try {
//       console.log("hi")
//       const res = await axios.post(`http://localhost:3000/api/upload/${id}`, formData, {
//         headers: {
...
//           <button style={{background:"white" , padding:"20px" , color:"red"}}
...
//         <div className="logo_s">Instagram</div>
//         <div className="navs">
//           <ul>
//             <li>
...
//           <source src={`data:${post.contentType};base64,${post.imageData}`} type={post.contentType} />
...
//           <div className="popup-content">
//             <h3>Create Post</h3>
//             <input type="file" accept="image/*, video/mp4, video/webm, video/quicktime" onChange={handlePostUpload} />
//             <button onClick={() => setShowPopup(false)}>Close</button>
//           </div>
//         </div>
//       )}
...
//       const response = await axios.post(`http://localhost:3000/api/update-bio/${userId}`, {
//         bio: updatedBio,
//       });
...
//   const [follower_c , setfollowers_count] = useState(0);
//   const [following_c , setfollowing_count]  = useState(0);
//   const [postDescription, setPostDescription] = useState(""); // New state for post description
...
//     className="popnew"
//   >
//     <div className="bg-white rounded-xl p-6 w-11/12 sm:w-3/4 lg:w-1/2 relative">
//       <button
//         onClick={closePopup}
...
import img_upload from "C:/Users/Home/Desktop/InPlant_training_2025/backend_pratise/server/Inten_project/insta/src/assets/Screenshot 2025-01-30 114823.png";
const Profile = () => {
  const { id } = useParams();
  const [profilePic, setProfilePic] = useState(null);
  const [posts, setPosts] = useState([]);
  ...
  {Array.isArray(fetchedbio) && fetchedbio.length > 0 ? (
    ...
    <p>No bio available</p>
      ...
      {/* Popup for creating posts */}
      {/* {showPopup && (
        <div className="custom-popup-content_new">
          <div className="custom-overlay_new">
            <h3>Create Post</h3>
            <input type="file" onChange={handlePostUpload} />
            <input
              type="text"

...
// //           <p onClick={() => navigate("/reels")} style={{backgroundColor:"blue" , padding:"10px" , width:"100px" , borderRadius:"10px" , marginLeft:"190px"}}>Create a Reel</p>
...
//   const [followersUsers, setFollowersUsers] = useState([]);
//   const [showFollowersPopup, setShowFollowersPopup] = useState(false);
//   const [showPopupReels , setshowPopupReels] = useState(false);
...
//         <div className="popup-overlay_new">
//           <div className="popup-container_new">
//           <p onClick={()=>Handlepopups()} style={{backgroundColor:"blue" , padding:"10px" , width:"100px" , borderRadius:"10px" , marginLeft:"190px"}}>Create a Reel</p>
//             <h3 className="popup-title_new">Create New Post</h3>
...
const [showPopupReels , setshowPopupReels] = useState(false);
  ...
  const handleUploadReels = async () => {
    ...
    formData2.append('media', selectedFile);

    setLoading(true);
    setError(null);

    try {
      const response = await axios.post(`http://localhost:3000/api/upload_reel/${id}`, formData2, {
        headers: { 'Content-Type': 'multipart/form-data' },
      });
